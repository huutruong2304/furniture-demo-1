# Project 1: Furniture E-Commerce Website
...
1.  **Clone the repository:**
    ...
    ```bash
    git clone https://github.com/huutruong2304/furniture-demo-1
    ```

2.  **Navigate to the project directory:**

    ```bash
    cd furniture-demo-1 or [your-repo-name]
    ```
...
If you find this project helpful and would like to support ame, consider buying me a coffee. Every contribution is greatly appreciated!
